...
<style>
body {
    background: linear-gradient(135deg, #d32f2f 0%, #b71c1c 50%, #8e24aa 100%);
    min-height: 100vh;
    overflow: hidden;
    position: relative;
}
...
.login-wrapper {
    ...
    max-width: 450px;
    pointer-events: auto;
    /* Re-enable clicks for login wrapper */
}
...
.login-card {
    ...
    position: relative;
    z-index: 20;
    /* HIGHEST z-index for login card */
    pointer-events: auto;
